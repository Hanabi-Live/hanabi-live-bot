...
def get_playful_mod_table(variant_name, preferred_modulus=None):
    ...
    if num_suits == 5:
        if preferred_modulus == 12:
            mod_table = {
                False: {
                    0: [(0,0)], 1: [(-1,0)], 2: [(0,-2)], 3: [(1,-2)],
                    4: [(2,-2)], 5: [(3,-2)], 6: [(4,-2)], 7: [(0,-3),(2,-3)],
                    8: [(1,-3),(3,-3)], 9: [(4,-3)],
                ...
                True: {
                    ...
                    8: [(1,-3)], 9: [(3,-3)],
                    10: [(4,-3)],
                    11: [(0,-4),(1,-4),(2,-4),(3,-4),(4,-4),(0,-5),(1,-5),(2,-5),(3,-5),(4,-5)]
                }
            }
            ...
            mod_table = {
                False: {
                    0: [(0,0)], 1: [(-1,0)], 2: [(0,-2)], 3: [(1,-2)],
                    4: [(2,-2)], 5: [(3,-2)], 6: [(4,-2)], 7: [(0,-3)],
                    8: [(1,-3)], 9: [(2,-3)], 10: [(3,-3)], 11: [(4,-3)],
                    12: [(0,-4),(2,-4)], 13: [(1,-4),(3,-4)], 14: [(4,-4)],
                    15: [(0,-5),(1,-5),(2,-5),(3,-5),(4,-5)]
                },
                True: {
                    0: [(0,0)], 1: [(-1,0)], 2: [(0,-2)], 3: [(1,-2)],
                    4: [(2,-2)], 5: [(3,-2)], 6: [(4,-2)], 7: [(0,-3)],
